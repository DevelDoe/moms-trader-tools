...
const DEFAULT_SETTINGS = {
    checklist: [
        ...
        { text: "50%", type: "reminder", state: "default", tooltip: "A stock that dumps more than 50% of its move often signals weak momentum and a potential trend reversal rather than a healthy pullback. When a stock retraces this deeply, it suggests that buyers are losing control, and sellers are stepping in aggressively." },
